    ...
    switch (activeView) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <form onSubmit={handleAddMeal}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" htmlFor="categories">
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" htmlFor="prepTime">
                    Preparation Time
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4 flex items-center">
                  ...
                  />
                  <label className="ml-2 block text-gray-700 dark:text-gray-300 text-sm font-bold" htmlFor="available">
                    Available
                  </label>
                </div>
              </div>
      ...
      case "update":
        return (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Update Menu Item</h2>
              <button
                onClick={() => setActiveView("main")}
                className="flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
              >
      ...
      case "delete":
        return (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Delete Menu Item</h2>
              <button
                onClick={() => setActiveView("main")}
                className="flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
              >
              ...
              <div>
                <div className="bg-red-50 dark:bg-red-900 p-4 rounded-lg mb-6">
                  <p className="text-red-800 dark:text-red-200 font-medium">
                    Are you sure you want to delete the following menu item? This action cannot be undone.
                  </p>
                </div>
        ...
        {activeView === "main" && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-blue-500">
              ...
              <p className="text-2xl font-bold text-gray-800 dark:text-white">{meals.length}</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border-l-4 border-purple-500">
              ...
              <p className="text-2xl font-bold text-gray-800 dark:text-white">
                ${meals.length > 0 
                  ? (meals.reduce((sum, meal) => sum + meal.price, 0) / meals.length).toFixed(2) 
                  : "0.00"}
              </p>
            </div>
          </div>
